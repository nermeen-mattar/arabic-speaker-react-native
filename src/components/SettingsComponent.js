    ...
    render() {
      ...
      // },
      {
        ...
        />
         ...
         <TouchableOpacity style={styles.logo}   onPress={() => Linking.openURL('https://bit.ly/3fMZFfM')}> 
           <Image style={{width: 166, height: 46}} source = {require('../../assets/images/Logo-AppsBunches.png')}/>
         </TouchableOpacity>
