...
CategoriesStack.navigationOptions = {
  tabBarLabel:  ({ focused }) => (
    <MonoText style={{textAlign: 'center', color: focused ? Colors.brand: Colors.grayFontColor}}> المكتبات </MonoText>  
  ),
...
SpeakingStack.navigationOptions = {
  tabBarLabel:  ({ focused }) => (
    <MonoText style={{textAlign: 'center', color: focused ?  Colors.brand: Colors.grayFontColor}}> التحدث </MonoText>  
  ),
  tabBarIcon:  ({ focused }) => (
...
FavourtiesStack.navigationOptions = {
  tabBarLabel:  ({ focused }) => (
    <MonoText style={{textAlign: 'center', color: focused ?  Colors.brand: Colors.grayFontColor}}> المفضلة </MonoText>  
  ),
  tabBarIcon:  ({ focused }) => (
...
AlertStack.navigationOptions = {
  tabBarLabel:  ({ focused }) => (
    <MonoText style={{textAlign: 'center', color: focused ?  Colors.brand: Colors.grayFontColor}}> تنبيه </MonoText>  
  ),
//   <TabBarIcon
//   focused={focused}
